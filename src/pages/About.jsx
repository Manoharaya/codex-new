  ...
  return (
    <div className="about-page chapter-about">
      ...
      <section className="about-hero">
        ...
        <div className="container about-hero-container">
          ...
          <div className="about-hero-content">
            ...
            >
              People Behind Every{" "}
              <span className="text-gradient">Intelligent Solution.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              We are engineers, designers, strategists and innovators passionate
              about building software that creates measurable business value.
              Every product we build begins with understanding people before
              writing code.
            </motion.p>
          </div>
              ...
              return (
                ...
                >
                  <div className="value-header-mobile">
                    ...
                    {isMobile && (
                      <h3 className="value-title-mobile">{value.title}</h3>
                    )}
                  </div>
                  ...
                  {(!isMobile || isExpanded) && (
                    <motion.div
                      ...
                      animate={
                        isMobile ? { height: "auto", opacity: 1 } : false
                      }
                    >
      ...
      <section className="about-stats-section">
        <div className="container">
          <div
            className={`about-stats-grid ${isMobile ? "stats-carousel" : ""}`}
          >
            ...
            <div className="culture-content">
              ...
              >
                ...
                <p className="culture-desc">
                  We believe the best products are built when engineering,
                  design, and business strategy sit at the same table.
                </p>
                {isMobile && (
                  <motion.div
              ...
              >
                ...
                <p className="culture-desc">
                  Technology moves fast. We allocate dedicated time for our
                  teams to experiment with new frameworks, AI models, and
              ...
              >
                ...
                <p className="culture-desc">
                  We don't just follow best practices; we aim to set them. Our
                  internal R&D ensures our clients always get cutting-edge
                  solutions.
                </p>
                {isMobile && (
                  <motion.div
