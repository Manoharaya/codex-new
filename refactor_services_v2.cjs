...
// 4. Change ONLY the desktop Link to a span.
// Desktop one has "inline-flex". Mobile one has "mt-2".
content = content.replace(
...
// 5. Add the CTA at the bottom of the section
const ctaHTML = `
        </motion.div>
